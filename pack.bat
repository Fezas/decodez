...
set JAVA_VERSION=17
set MAIN_JAR=decodez-1.0-SNAPSHOT.jar
...
"%JAVA_HOME%\bin\jdeps" ^
  ...
  --print-module-deps target\classes\fezas\decodez\MainApplication.class > temp.txt
...
call "%JAVA_HOME%\bin\jpackage" ^
  ...
  --name decodeZ ^
  --main-class fezas.decodez.MainApplication ^
  --main-jar %MAIN_JAR% ^
  --java-options -Xmx2048m ^
  --icon src/main/resources/image/icons8-file-64.ico ^
